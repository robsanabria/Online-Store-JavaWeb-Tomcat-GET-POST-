...
<audio src="sounds/success.mp3" autoplay="autoplay"></audio>
<body>
<div class="checkmark">
...
<p>¡Felicitaciones, recibimos tu orden de compra, podes ver el estado de tus pedidos desde <a href="cliente?accion=pedidos">acá!</a></p>
</div>
