      ...
      <% List<Compra> compras = CompraDAO.obtenerCompras();
         for (Compra compra : compras) { %>
          <tr>
            ...
            <td><%= compra.getPrecioTotal() %></td>
           <td><%= compra.isEntregado() ? "Si" : "No" %></td>
            <td>
              <form class="form-check form-switch" method="post" action="administrador?accion=actualizarEstadoEntregado">
                <input type="hidden" name="idCompra" value="<%= compra.getIdCompra() %>">
                <input class="form-check-input" type="checkbox" id="estadoEntregado<%= compra.getIdCompra() %>" name="estadoEntregado" <%= compra.isEntregado() ? "checked" : "" %> onchange="this.form.submit()">
                <label class="form-check-label" for="estadoEntregado<%= compra.getIdCompra() %>">Entregado</label>
              </form>
            </td>
          </tr>
      <% } %>
